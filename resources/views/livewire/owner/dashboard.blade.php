                                    ...
                                    <div class="ml-10 bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                                        <table class="w-full text-sm text-left">
                                            ...
                                            <tfoot class="border-t border-gray-100 bg-gray-50/30">
                                                <tr>
                                                    <td colspan="3" class="px-4 py-2 text-right text-xs font-semibold text-gray-500 uppercase">Subtotal</td>
                                                ...
                                                <tr>
                                                    <td colspan="3" class="px-4 py-2 text-right text-xs font-semibold text-green-600 uppercase">Diskon ({{ $order->promoCode->code ?? 'Promo' }})</td>
                                                    <td class="px-4 py-2 text-right font-medium text-green-600">- Rp {{ number_format($order->discount_amount, 0, ',', '.') }}</td>
                                                </tr>
                                                @endif
                                                <tr>
                                                ...
                                                <tr>
                                                    <td colspan="3" class="px-4 py-2 text-right text-xs font-semibold text-gray-500 uppercase">{{ $order->service_charge_type === 'fixed' ? 'Biaya Layanan' : 'Biaya Layanan (' . floatval($order->service_charge_rate) . '%)' }}</td>
                                                    <td class="px-4 py-2 text-right font-medium text-gray-700">Rp {{ number_format($order->service_charge_amount, 0, ',', '.') }}</td>
                                                </tr>
                                                <tr class="border-t border-gray-200">
                                                    <td colspan="3" class="px-4 py-3 text-right text-sm font-bold text-gray-800 uppercase">Total</td>
                                                    <td class="px-4 py-3 text-right font-bold text-toreno-brown">Rp {{ number_format($order->total_amount, 0, ',', '.') }}</td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                        @if($order->notes)
